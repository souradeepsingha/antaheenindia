...
<a href="#" class="logo">Antoheen india <span>.</span></a>

<nav class="navbar">
    <ul>
        <li><a data-scroll="home" href="#home" class="active" style="color: #75fa09;">home</a></li>
        <li><a data-scroll="feature" href="#feature" style="color: #f57207;">feature</a></li>
        <li><a data-scroll="about" href="#about" style="color: #b60afa;">about</a></li>
...
<!-- <div class="content">
    <h2 style="background-color: #fdc9f9;color: #93fd09;border-radius: 10px;">antaheen bangla</h2>
